    ...
    return declare({
        instance : {
            ...
            start : function(placeholder) {
                ...
                this.iframe = $('<iframe src="' + src + '" style="border: none; frameborder: 0; overflow: hidden; width: 1100px; transform: translateX(-230px); min-height: 685px; position: relative;" scrolling="no" ></iframe></div></div>');
