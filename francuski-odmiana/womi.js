    ...
    return declare({
        instance : {
            ...
            start : function(placeholder) {
                ...
                this.iframe = $('<iframe src="' + src + '" style="border: none; frameborder: 0; overflow: hidden; width: 82vw; min-width: 800px; transform: translateX(-21vw); min-height: 430px; position: relative;" scrolling="no" ></iframe></div></div>');
