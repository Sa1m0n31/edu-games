    ...
    return declare({
        instance : {
            ...
            start : function(placeholder) {
                ...
                this.iframe = $('<iframe src="' + src + '" style="border: none; frameborder: 0; overflow: hidden; width: 80vw; max-width: 640px; min-height: 450px; position: relative;" scrolling="no" ></iframe></div></div>');
